...
// Inspired by https://github.com/sehraf/advent-of-code/blob/main/src/day17.rs
fn solve(input: &str) -> u32 {
    ...
    while let Some((curr_heat_loss, curr_x, curr_y, curr_dir_x, curr_dir_y)) = queue.pop_first() {
        ...
        for (dir_x, dir_y) in possible_directions {
            ...
            // Go up to 10 tiles forward in the selected direction
            // Only add if traveled more than 4 tiles.
            for mult in 1..=10 {
